...
export default {
  ...
  methods: {
    ...
    async fetchNomineesList() {
      try {
        const { data } = await axios.get(
          "https://amacserver-production-7a96.up.railway.app/api/nominee/list"
        );
    ...
    async fetchTransaction() {
      try {
        const { data } = await axios.get(
          "https://amacserver-production-7a96.up.railway.app/transaction/getAllPayments"
        );
    ...
    async fetchVotes() {
      try {
        const { data } = await axios.get(
          "https://amacserver-production-7a96.up.railway.app/api/votes/get-all-votes"
        );
    ...
    async fetchDashboard() {
      try {
        const { data } = await axios.get(
          "https://amacserver-production-7a96.up.railway.app/api/votes/dashboard-total"
        );

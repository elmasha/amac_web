...
<h2 style="font-size: 1rem;">
     <span style="font-size: 1rem;">{{ timeLeft.days }}d :</span>
    <span style="font-size: 1rem;">{{ timeLeft.hours }}h :</span>
    <span style="font-size: 1rem;">{{ timeLeft.minutes }}m :</span>
    <span style="font-size: 1rem;">{{ timeLeft.seconds }}s</span>
   </h2>
    </div>
